            ...
            title={(
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
                    ...
                    >
                        ...
                        >
                            <span className="material-symbols-outlined" aria-hidden="true" focusable="false" style={{ fontSize: '16px' }}>content_copy</span>
                        </span>
                        ...
                        >
                            <span className="material-symbols-outlined" aria-hidden="true" focusable="false" style={{ fontSize: '16px' }}>save</span>
                        </span>
                    </div>
                </div>
            )}
