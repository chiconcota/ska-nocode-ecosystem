 ...
 * 
 * Circuit Breaker: This class only runs if both Ska Data Pro and Ska Logic Engine are active.
 */
...
class Ska_Template_Router {
    ...
    public function intercept_template( $template ) {
        ...
        // 2. Kéo template ID từ Flat Table (ska_data_sys_organisms với type = template).
