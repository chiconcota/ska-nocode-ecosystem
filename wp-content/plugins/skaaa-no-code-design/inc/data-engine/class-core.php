...
use Skaaa\Builder\Data\Providers\WP_Post_Provider;
use Skaaa\Builder\Data\Providers\SCF_Provider;
use Skaaa\Builder\Data\Providers\Term_Provider;
use Skaaa\Builder\Data\Providers\User_Provider;
...
class Core {
	...
	private function init_hooks() {
		add_filter( 'skaaa_bind_data', array( $this, 'bind_data' ), 10, 2 );
		add_filter( 'skaaa_get_field', array( $this, 'get_field_value' ), 10, 3 );
	}
