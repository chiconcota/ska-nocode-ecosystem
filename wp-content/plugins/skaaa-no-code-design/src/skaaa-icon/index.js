...
registerBlockType(metadata.name, {
    edit: (props) => {
        ...
        const blockProps = useBlockProps({
            className: `skaaa-icon-block wp-block-skaaaaa-builder-icon material-symbols-outlined ${tailwindClasses}`.trim(),
        ...
        return (
            <>
                <InspectorControls>
                    <PanelBody title={__('Icon Selection', 'skaaaaa-builder-core')} initialOpen={true}>
                        ...
                        <TextControl
                            label={__('Icon Name', 'skaaaaa-builder-core')}
                        ...
                        >
                            ...
                            {__('Browse Icons', 'skaaaaa-builder-core')} ({ALL_ICONS.length})
                        </Button>
                    </PanelBody>
                ...
                {isModalOpen && (
                    <Modal
                        title={__('Material Icons Library', 'skaaaaa-builder-core')}
                    ...
                    >
                        ...
                        <div style={{ marginBottom: '16px' }}>
                            <TextControl
                                placeholder={__('Search 4207 icons... (VD: payment, star, home)', 'skaaaaa-builder-core')}
                                value={modalSearch}
