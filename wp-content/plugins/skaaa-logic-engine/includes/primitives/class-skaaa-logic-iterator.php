...
class Skaaa_Logic_Iterator implements Skaaa_Logic_Node {
    ...
    public function execute( $payload, $config ) {
        ...
        if ( ! empty( $array_source ) ) {
            try {
                ...
                $eval_result = \Skaaa\Logic\SkaaaFX\SkaaaFX_Engine::execute( $array_source, $payload );
                ...
                error_log( 'Skaaa Logic Iterator: Lỗi khi evaluate array_source - ' . $e->getMessage() );
                $items = [];
            }
        }
