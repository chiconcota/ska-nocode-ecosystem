...
/**
 * Class Skaaa_Provider
 * Đóng vai trò Data Provider (Cầu nối) cho Cỗ Máy Nội Suy (Data Engine) của Skaaa Builder Core.
 * Xử lý các tag dạng {{skaaa:tên_cột}}.
 */
class Skaaa_Provider implements \Skaaa\Builder\Data\Provider {

	/**
	 * Định danh Provider (Slug).
	 * VD: prefix `skaaa:` trong tag `{{skaaa:product_price}}`
	 */
	...
	public function get_field( string $key, int $id, array $context ) {
		...
		$row = apply_filters( 'skaaa_data_get_row', null, $context['table'], $id );
