...
export default class CellRegistry {
    ...
    static attachInlineEditEvent() {
        document.querySelectorAll('.skaaa-editable-cell').forEach(cell => {
            if ( cell.getAttribute('data-col') === 'id' ) {
                cell.classList.remove('skaaa-editable-cell', 'cursor-text', 'hover:bg-gray-100/80');
                cell.title = __( 'The primary key (ID) cannot be edited', 'skaaa-data-pro' );
            ...
            cell.addEventListener('click', function(e) {
                ...
                if (e.target.closest('#skaaa-datagrid-popover')) return;
