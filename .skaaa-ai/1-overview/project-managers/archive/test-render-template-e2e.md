...
**Các bước thực hiện:**
1. Truy cập trang quản trị DAG Workflow của **Skaaa Logic Engine** (Ví dụ: `WP Admin -> Skaaa Builder -> Workflows`).
...
4. Tại ô nhập **Template HTML / Variable**, hãy điền một đoạn HTML mẫu có chứa các tag Mustache (SkaaaFX):
   ```html
