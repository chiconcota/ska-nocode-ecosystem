...
## 1. TẦM NHÌN (VISION)
Cung cấp hạ tầng cốt lõi để đưa Skaaa từ "Website Builder" lên tầm "App Builder". Xóa bỏ hoàn toàn sự phụ thuộc vào `/wp-admin` để quản lý dữ liệu, tạo ra các giao diện quản trị Frontend (Portals) độc lập, bảo mật và chuẩn White-label (có thể đóng gói đem bán).

## 2. QUYẾT ĐỊNH KIẾN TRÚC (ARCHITECTURE DECISIONS)
- **Data Pro Integration (No Shadow CPT):** Mở rộng **Skaaa Data Pro** để quản lý App Portals trực tiếp từ Smart Object thay vì tạo Shadow CPT thừa thãi.
...
### Phase 1: App Portal Configuration (Skaaa Data Pro)
...
- [x] **Task 1.2: Portal Settings UI:** Nâng cấp UI ở `/wp-admin` của Skaaa Data Pro, thêm modal/panel "App Portal Settings" trên DataGrid để thiết lập cấu hình.
...
### Phase 2: Virtual Router & Security Layer (Skaaa Theme Builder)
...
### Phase 3: Data View Engine (Skaaa Data Pro & Logic Engine)
