...
│   ├── ska-data-pro/           (Tài liệu kiến trúc Database, Smart Object Blueprint)
│   ├── ska-logic-engine/       (Tài liệu kiến trúc Logic, Event Pipeline, Form)
│   └── ska-bridge/             (Tài liệu kiến trúc Adapter chuyển đổi html2tailwind)
└── 4-rules/
