...
1. **Khởi động bộ nhớ (Context Loading - Mới):**
   ...
   - Dựa trên file checkpoint, đọc file project manager đang làm, trong thưc mục '.ska-ai/1-overview/project-managers' để biết công việc đang ở giai đoạn nào 
   ...
   - Đọc file `.ska-ai/2-memory/self-improve.md` để nạp danh sách lỗi hành vi cần tránh và quy tắc tự sửa lỗi của Agent.
