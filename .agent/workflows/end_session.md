...
Bước 3. **Ghi sổ quyết định (Decision Log, System Map, self-improve & Update):**
   ...
   - Mở và GHI ĐÈ dữ liệu vào file tương ứng với module tương ứng `.ska-ai/1-overview/project-managers/` để lưu lại tiến độ dự án.
...
Bước 4. **Đánh giá phiên làm việc tương tác (Interactive Session Review & self-improve):**
   ...
   - Chỉ cập nhật tệp `.ska-ai/2-memory/self-improve.md` sau khi User đồng ý hoặc đưa ra chỉnh sửa.
   - Cập nhật trạng thái các lỗi đã giải quyết (Resolved). Nếu độ dài file vượt quá 80 dòng, thực hiện rút gọn, gộp nhóm và di chuyển các lỗi đã sửa lâu ngày vào `.ska-ai/2-memory/archive/mistake-history.md`.
