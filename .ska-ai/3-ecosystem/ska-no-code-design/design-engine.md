...
3. **Lớp 3 (Visual Tailwind Browser):** Bảng điều khiển Override cho Nocode User. Không dùng input text tự gõ, mà dùng UI chọn biến số từ Lớp 1 (Color Swatch, Spacing Scale).
