...
- **Form Preflight & Native Reset (2026-04-06):** Thiết lập Reset cấp độ Structural dài dòng (VD: `.editor-styles-wrapper .block-editor-block-list__block.wp-block-ska-builder-input`) mang Specificity cao (30) nhưng KHÔNG có `!important` để dọn sạch CSS của WP Admin Editor. Sau đó nhường đường cho CDN (có `!important`) thắng tuyệt đối.
