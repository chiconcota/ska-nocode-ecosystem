...
- [ ] **Task 5: Logic Engine Node - "Table Listener" (Post-MVP / Milestone 1):** Viết Trigger Node mới trong Ska Logic Engine chuyên để lắng nghe Hook `ska_data_updated` và nạp tự động `Record_Data` vào Context của Workflow.
