...
Tài liệu này hướng dẫn người dùng cuối (End-user/Admin) cách thức kiểm thử tính năng **Tùy chỉnh trang chuyển hướng khi chưa đăng nhập (Unauthorized Custom Redirect)** của Ska App Builder.
...
1. Truy cập vào menu **Ska Data Pro** trên thanh sidebar bên trái.
...
1. Truy cập vào **Ska Theme Builder**.
