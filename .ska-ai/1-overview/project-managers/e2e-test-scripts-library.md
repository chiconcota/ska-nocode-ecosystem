# E2E Test Workflow: Ska Scripts Library (v1.2.2)
@target: Ska Data Pro | @milestone: 1 (Post-MVP)

Tài liệu này hướng dẫn các bước kiểm thử E2E thủ công để nghiệm thu tính năng **Ska Scripts Library** (Quản lý mã nhúng tùy biến JS/CSS) và bộ biên dịch **JIT Tailwind CSS** cục bộ.
...
- [x] **Bước 1.2:** Nhấp chuột vào menu chính **Ska Ecosystem** để truy cập Dashboard tổng.
...
- [x] **Bước 1.4:** Xác nhận trình duyệt chuyển hướng thành công đến địa chỉ URL:
  `wp-admin/admin.php?page=ska-data-pro-scripts`
...
- [x] **Bước 2.2:** Tìm trong thẻ `<head>` hoặc đầu phần body, xác nhận có sự tồn tại của thẻ style:
  `<style id="ska-scripts-tailwind-jit">...</style>`
...
- [x] **Bước 3.1.3:** Điền các thông tin thử nghiệm sau:
  ...
  - *Code Content:* Gõ đoạn mã JS:
    ```javascript
    console.log("⚡ [Ska E2E Test] Scripts Library is working perfectly!");
    ```
...
- [x] **Bước 3.2.3:** Nhấn F12 chọn tab **Console**. Xác nhận có in ra dòng log:
  `⚡ [Ska E2E Test] Scripts Library is working perfectly!`
