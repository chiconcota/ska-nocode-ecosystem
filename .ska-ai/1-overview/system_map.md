...
- **2026-04-24 - 🟢 Tối ưu Hóa Giao diện Quản trị & Dashboard:** Bổ sung Dynamic Submenu đăng ký trực tiếp các Workflows lên sidebar WordPress giúp truy cập Builder nhanh chóng. Đồng bộ hóa toàn bộ Ecosystem System Dashboard với thiết kế `.module-card` cao cấp. Khắc phục lỗi CSS tràn khung (Overflow) tại Settings Panel và vá lỗi rủi ro Fatal Error do tham chiếu PHP trong luồng Execute Node của Logic Engine.
