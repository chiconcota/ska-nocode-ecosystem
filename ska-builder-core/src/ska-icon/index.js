    ...
    edit: (props) => {
        ...
        return (
            <>
                <InspectorControls>
                    <PanelBody title={__('Icon Selection', 'ska-builder-core')} initialOpen={true}>
                        ...
                        <div style={{
                            ...
                            <span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: '36px' }}>{iconName || 'star'}</span>
                            <div style={{ flex: 1 }}>
                        ...
                        >
                            <span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: '18px', marginRight: '6px' }}>apps</span>
                        ...
                        <div style={{
                            ...
                            {modalFilteredIcons.map(icon => (
                                <Button
                                    ...
                                    title={icon}
                                >
                                    <span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: '24px' }}>{icon}</span>
                                    <span style={{
                                        fontSize: '9px',
                                        color: '#666',
                                        maxWidth: '100%',
                ...
                <span aria-hidden="true" {...blockProps}>
                    {iconName || 'star'}
                </span>
            </>
        );
