                ...
                <div {...blockProps}>
                    {dynamic.source === 'static' ? (
                        url ? (
                            <img src={url} alt={alt} className={tailwindClasses || ''} style={{ maxWidth: '100%', height: 'auto', display: 'block' }} />
                                ...
                                <div className={tailwindClasses || ''} style={{
                                    ...
                                    <span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: '48px', color: '#ccc', marginBottom: '10px' }}>image</span>
                        ...
                        <div style={{
                            ...
                            <span aria-hidden="true" className="material-symbols-outlined" style={{ verticalAlign: 'middle', marginRight: '5px' }}>settings_backup_restore</span>
